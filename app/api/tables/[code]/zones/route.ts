...
// Teto de divisões por Mesa — zonas são sempre exibidas lado a lado com
// largura igual (ver `TableBoard.tsx`), então um número muito alto deixaria
// cada uma ilegível numa tela normal/telão.
...
// Cria uma nova divisão/zona no tabuleiro. App de uso pessoal — sem checagem
// de Mestre (ver `.claude/rules/table-concept.md`).
